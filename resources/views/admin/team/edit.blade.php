...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title center">{{ $team->name}} Detail</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <form class="space-y-3" action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control-alt form-control" id="facebook" name="facebook" placeholder="Enter facebook URL" value="{{ old('facebook')? old('facebook'): '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control-alt form-control" id="linkedin" name="linkedin" placeholder="Enter linkedin URL" value="{{ old('linkedin')? old('linkedin'): '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control-alt form-control" id="twitter" name="twitter" placeholder="Enter twitter URL" value="{{ old('twitter')? old('twitter'): '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control-alt form-control" id="instagram" name="instagram" placeholder="Enter Instagram URL" value="{{ old('instagram')? old('instagram'): '' }}">
