 ...
 <footer class="footer-one footer-bg  position-relative">
      <img src="{{asset('frontend/images/footer/4.png')}}" class="img-fluid fshap-after" alt="image">
          ...
          <div class="row ">
            <div class="col-lg-4 col-md-6">
              <div class="iq-footer-logo">
                <a href="index.html"><img src="{{asset('frontend/images/footer/logo.png')}}" class="img-fluid" alt="image"></a>
              </div>
