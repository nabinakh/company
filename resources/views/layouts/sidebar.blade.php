        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item{{ request()->is('admin/service/*') ? ' open' : '' }}">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('admin/service') ? ' active' : '' }}" href="{{ route('service.create')}}">
                    <span class="nav-main-link-name">Add Service</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('admin/service') ? ' active' : '' }}" href="{{ route('service.index')}}">
